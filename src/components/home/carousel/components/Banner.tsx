...
function Banner({ items, interval, className }: bannerProps) {
    ...
    const plugin = React.useRef(Autoplay({ delay: interval, stopOnInteraction: false }))
    ...
    return (
        <div className={cn(className)}>
            <Carousel
                ...
                className='w-full max-h-full lg:pl-[44px] sm:pt-[44px] flex justify-center relative'
                opts={{
                    loop: true
                }}
            >
